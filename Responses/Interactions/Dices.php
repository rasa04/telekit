            ...
            $result = [
                [
                    ...
                    "input_message_content" => [
                        "message_text" => "<code>d$dice_value</code> <b>результат:</b> <code>" . strval(rand(1, $dice_value)) . "</code>",
                        "parse_mode" => "HTML"
                    ]
                ]
            ];
        }
        elseif (preg_match("/^([1-9]|[1-9][0-9])(d|к)\d/", $this->request_query))
        {
